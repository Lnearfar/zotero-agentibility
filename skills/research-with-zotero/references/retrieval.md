...
1. Obtain a stable Item Key from the user or by navigating known Collections with `ls`. Version 0.1.2 has no library-wide semantic search; report that limitation rather than scanning the entire Library.
